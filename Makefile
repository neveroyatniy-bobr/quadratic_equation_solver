# // FIXME исправить make по гайду!!! Сл задача: написать стандартные строковые фунцие 
...
all: $(MY_PROGRAM) doxygen

$(MY_PROGRAM): $(OBJ) main.o
	g++ -Iinclude $(OBJ) main.o -o $(MY_PROGRAM) $(FLAGS)
	echo $(RED) "\n!!! COMMIT GITHUB !!!\n" $(RESET)
